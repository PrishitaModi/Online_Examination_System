...
<div class="card">
	<div class="card-header">
		...
		<div id="user_details_area" style="height:15%;"></div>
		</div>
...
for($i=1;$i<=$adminid;$i++)
                     
    {
		...
		//$exam_id = $row['online_exam_duration'];
	}
	//$db = mysqli_connect('localhost','root', '','online_examination' );
...
$uquery = "UPDATE user_exam_enroll_table SET attendance_status='$attendance_status' WHERE user_id='$user_id' AND exam_id='$exam_id'";
