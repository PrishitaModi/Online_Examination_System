        ...
        <div class="dashboard-header">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                             ...
                             <li class="nav-item">
                                <a class="nav-link" href="user.php"><i class=""></i>Students Enrolled</a>
                            </li>
                             <li class="nav-item">
                                <a class="nav-link" href="logout.php"><i class=""></i>Admin Logout</a>
                            </li>
                        </ul>
                    </div>
                </li>
         ...
         <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                      ...
                      <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Admin Side </h2>
                ...
                <h3 class="mb-1"><a href="exam.php"><i class='fas fa-edit' aria-hidden="true"></i>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted"></h5>
                                        <div class="metric-value d-inline-block">
                                            <h3 class="mb-1"><a href="user.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Students Enrolled</a></h3>
                                        </div>
                         ...
                         <!-- <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted"></h5>
                                        <div class="metric-value d-inline-block">
                                            <h3 class="mb-1"><a href="admin_exam_result.php">Exam Result</a></h3>
                                        </div>
                                        <div class="metric-label d-inline-block float-right text-secondary font-weight-bold">
                                            <span>-2.00%</span>
                                         </div>
