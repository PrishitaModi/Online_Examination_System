	...
	<nav class="fh5co-nav" role="navigation">
		...
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="index.html"><i class="icon-study"></i>HomeSchool<span>.</span></a></div>
					</div>
					<div class="col-xs-10 text-right menu-1" style="padding-top: 20px;">
						<ul>
							...
							<li class="btn-cta"><a href="LR page/master/login.php"><span> Admin Login</span></a></li>
							<li class="btn-cta"><a href="LR page/user/login.php"><span>Students login</span></a></li>
						</ul>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							<h3><a href="master/login.php">ADMIN MODULE</a></h3>
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						...
						<div class="desc">
							<h3><a href="user/login.php">USER MODULE</a></h3>
							<p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
							<!-- <span><a href="#" class="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						 --></div>
					</div>
		...
		<div class="container">
			<div class="row row-pb-md">
				<div class="col-md-3 fh5co-widget">
					<h3>Contact us</h3>
					<p>Office no.2,<br>Govardhan Complex,<br>Valsad-396001</p>
				</div>
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						...
						<small class="block">Designed by <a href="http://freehtml5.co/" target="_blank">Akshar Tech</a> <a href="http://unsplash.co/" target="_blank"></a> <a href="https://www.pexels.com/" target="_blank"></a></small>
					</p>
				</div>
			</div>
